...
use UserFrosting\Sprinkle\Account\Controller\ForgetPasswordRequestAction;
...
class AuthRoutes implements RouteDefinitionInterface
{
    public function register(App $app): void
    {
        ...
        $app->group('/account', function (RouteCollectorProxy $group) {
            ...
            $group->post('/forgot-password/request', ForgetPasswordRequestAction::class)->setName('account.forgotPassword.request');
