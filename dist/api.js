...
import { AlertStyle as ae } from "./types.js";
import { u as z } from "./auth-B0ne5h5X.js";
function Ce(e, t) {
  return function() {
    return e.apply(t, arguments);
  };
}
const { toString: Qe } = Object.prototype, { getPrototypeOf: ce } = Object, V = /* @__PURE__ */ ((e) => (t) => {
  const n = Qe.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), A = (e) => (e = e.toLowerCase(), (t) => V(t) === e), W = (e) => (t) => typeof t === e, { isArray: B } = Array, j = W("undefined");
function Ze(e) {
...
const et = W("string"), O = W("function"), Pe = W("number"), $ = (e) => e !== null && typeof e == "object", tt = (e) => e === !0 || e === !1, I = (e) => {
  if (V(e) !== "object")
    return !1;
  const t = ce(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, nt = A("Date"), rt = A("File"), st = A("Blob"), ot = A("FileList"), it = (e) => $(e) && O(e.pipe), at = (e) => {
  let t;
  return e && (typeof FormData == "function" && e instanceof FormData || O(e.append) && ((t = V(e)) === "formdata" || // detect form-data instance
  t === "object" && O(e.toString) && e.toString() === "[object FormData]"));
}, ct = A("URLSearchParams"), [ut, lt, ft, dt] = ["ReadableStream", "Request", "Response", "Headers"].map(A), pt = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
function ee() {
  const { caseless: e } = _e(this) && this || {}, t = {}, n = (r, s) => {
    const o = e && Fe(t, s) || s;
    I(t[o]) && I(r) ? t[o] = ee(t[o], r) : I(r) ? t[o] = ee({}, r) : B(r) ? t[o] = r.slice() : t[o] = r;
  };
...
const ht = (e, t, n, { allOwnKeys: r } = {}) => (q(t, (s, o) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, gt = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && ce(Uint8Array)), Rt = (e, t) => {
  ...
  for (; (n = e.exec(t)) !== null; )
    r.push(n);
  return r;
}, Ot = A("HTMLFormElement"), Tt = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), he = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), At = A("RegExp"), Be = (e, t) => {
...
}, Pt = (e, t) => e != null && Number.isFinite(e = +e) ? e : t, X = "abcdefghijklmnopqrstuvwxyz", me = "0123456789", De = {
  DIGIT: me,
  ALPHA: X,
...
const _t = (e) => {
  ...
  return n(e, 0);
}, Bt = A("AsyncFunction"), Dt = (e) => e && ($(e) || O(e)) && O(e.then) && O(e.catch), a = {
  isArray: B,
  isArrayBuffer: Ne,
  isBuffer: Ze,
  isFormData: at,
...
function K(e, t, n) {
  ...
  function u(d, m, g) {
    ...
    if (d && !g && typeof d == "object") {
      ...
      else if (a.isArray(d) && kt(d) || (a.isFileList(d) || a.endsWith(m, "[]")) && (R = a.toArray(d)))
        return m = je(m), R.forEach(function(w, U) {
          !(a.isUndefined(w) || w === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            i === !0 ? ye([m], U, o) : i === null ? m : m + "[]",
            l(w)
          );
        }), !1;
    }
    return te(d) ? !0 : (t.append(ye(g, m, o), l(d)), !1);
  }
  ...
  function y(d, m) {
    if (!a.isUndefined(d)) {
      ...
      p.push(d), a.forEach(d, function(R, x) {
...
}, Ht = typeof URLSearchParams < "u" ? URLSearchParams : ue, It = typeof FormData < "u" ? FormData : null, Mt = typeof Blob < "u" ? Blob : null, zt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Ht,
    FormData: It,
...
}, le = typeof window < "u" && typeof document < "u", vt = ((e) => le && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(typeof navigator < "u" && navigator.product), Jt = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Vt = le && window.location.href || "http://localhost", Wt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: le,
...
class S {
  ...
  set(t, n, r) {
    ...
    function o(c, f, l) {
      ...
      (!p || s[p] === void 0 || l === !0 || l === void 0 && s[p] !== !1) && (s[p || f] = M(c));
    }
...
const Ve = (e) => {
  ...
  t.headers = i = S.from(i), t.url = He(Je(t.baseURL, t.url), e.params, e.paramsSerializer), c && i.set(
    "Authorization",
  ...
  if (T.hasStandardBrowserEnv && (r && a.isFunction(r) && (r = r(t)), r || r !== !1 && an(t.url))) {
...
}, G = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", We = G && typeof ReadableStream == "function", ne = G && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), yn = We && (() => {
  let e = !1;
...
const wn = async (e) => {
  ...
  let x;
  try {
    if (f && yn && n !== "get" && n !== "head" && (x = await bn(u, r)) !== 0) {
      let C = new Request(t, {
        method: "POST",
        body: r,
        duplex: "half"
      }), L;
      a.isFormData(r) && (L = C.headers.get("content-type")) && u.setContentType(L), C.body && (r = Re(C.body, Oe, Se(
        x,
        v(f)
      ), null, ne));
    }
    a.isString(p) || (p = p ? "cors" : "omit"), g = new Request(t, {
      ...E,
      signal: y,
    ...
    let w = await fetch(g);
    const U = re && (l === "stream" || l === "response");
    if (re && (c || U)) {
      const C = {};
    ...
    l = l || "text";
    let Xe = await J[a.findKey(J, l) || "text"](w, e);
    return !U && R(), d && d(), await new Promise((C, L) => {
      ve(C, L, {
        data: Xe,
...
const Te = (e) => `- ${e}`, gn = (e) => a.isFunction(e) || e === null || e === !1, $e = {
  getAdapter: (e) => {
    e = a.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
    ...
    for (let o = 0; o < t; o++) {
      n = e[o];
      let i;
      if (r = n, !gn(n) && (r = se[(i = String(n)).toLowerCase()], r === void 0))
...
function Ae(e) {
  return Y(e), e.headers = S.from(e.headers), e.data = Z.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), $e.getAdapter(e.adapter || H.adapter)(e).then(function(r) {
...
function Ge(e) {
  const t = new P(e), n = Ce(P.prototype.request, t);
...
b.mergeConfig = F;
b.AxiosHeaders = S;
b.formToJSON = (e) => Me(a.isHTMLForm(e) ? new FormData(e) : e);
b.getAdapter = $e.getAdapter;
b.HttpStatusCode = ie;
b.default = b;
function Cn() {
  const e = _(!1), t = _();
  return { loading: e, error: t, check: () => {
    e.value = !0, t.value = void 0, b.get("/account/auth-check").then((r) => {
      z().setUser(r.data.user);
    }).catch((r) => {
      z().unsetUser(), t.value = {
        ...r.response.data,
        style: ae.Danger,
...
function Nn() {
  const e = _(!1), t = _();
  return { loading: e, error: t, login: (r) => {
    e.value = !0, t.value = void 0, b.post("/account/login", r).then((s) => {
      z().setUser(s.data);
    }).catch((s) => {
      t.value = {
        ...s.response.data,
...
function Pn() {
  const e = _(!1), t = _();
  return { loading: e, error: t, logout: () => {
    e.value = !0, t.value = void 0, z().unsetUser(), b.get("/account/logout").catch((s) => {
      t.value = {
        ...s.response.data,
        style: ae.Danger,
        closeBtn: !0
