...
const { toString: Ye } = Object.prototype, { getPrototypeOf: ue } = Object, $ = /* @__PURE__ */ ((e) => (t) => {
  const n = Ye.call(t);
...
const nt = v("string"), T = v("function"), _e = v("number"), K = (e) => e !== null && typeof e == "object", rt = (e) => e === !0 || e === !1, z = (e) => {
  if ($(e) !== "object")
    return !1;
  const t = ue(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, st = C("Date"), ot = C("File"), it = C("Blob"), at = C("FileList"), ct = (e) => K(e) && T(e.pipe), ut = (e) => {
  let t;
...
const yt = (e, t, n, { allOwnKeys: r } = {}) => (H(t, (s, o) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, gt = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && ue(Uint8Array)), Ot = (e, t) => {
...
), me = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), Ct = C("RegExp"), De = (e, t) => {
...
}, _t = (e, t) => e != null && Number.isFinite(e = +e) ? e : t, Z = "abcdefghijklmnopqrstuvwxyz", ye = "0123456789", Ue = {
  DIGIT: ye,
  ALPHA: Z,
...
const Dt = (e) => {
  ...
  return n(e, 0);
}, Ut = C("AsyncFunction"), kt = (e) => e && (K(e) || T(e)) && T(e.then) && T(e.catch), ke = ((e, t) => e ? setImmediate : t ? ((n, r) => (L.addEventListener("message", ({ source: s, data: o }) => {
  ...
  T(L.postMessage)
), jt = typeof queueMicrotask < "u" ? queueMicrotask.bind(L) : typeof process < "u" && process.nextTick || ke, a = {
  isArray: U,
  isArrayBuffer: Fe,
  isBuffer: et,
  isFormData: ut,
...
function G(e, t, n) {
  ...
  function l(h, y, d) {
    ...
    if (h && !d && typeof h == "object") {
      ...
      else if (a.isArray(h) && Ht(h) || (a.isFileList(h) || a.endsWith(y, "[]")) && (S = a.toArray(h)))
...
}, zt = typeof URLSearchParams < "u" ? URLSearchParams : le, Jt = typeof FormData < "u" ? FormData : null, Vt = typeof Blob < "u" ? Blob : null, Wt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: zt,
    FormData: Jt,
...
}, fe = typeof window < "u" && typeof document < "u", $t = ((e) => fe && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(typeof navigator < "u" && navigator.product), vt = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", Kt = fe && window.location.href || "http://localhost", Gt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: fe,
...
}, ge = (e) => (...t) => a.asap(() => e(...t)), ln = x.hasStandardBrowserEnv ? (
...
const ve = (e) => {
  ...
  t.headers = i = g.from(i), t.url = Me($e(t.baseURL, t.url), e.params, e.paramsSerializer), c && i.set(
    "Authorization",
  ...
  if (x.hasStandardBrowserEnv && (r && a.isFunction(r) && (r = r(t)), r || r !== !1 && ln(t.url))) {
  ...
  return e && !t;
}), Ae = 64 * 1024, oe = Ke && Ge(() => a.isReadableStream(new Response("").body)), W = {
  stream: oe && ((e) => e.body)
};
X && ((e) => {
...
const Rn = async (e) => {
  ...
  let O;
  try {
    if (f && En && n !== "get" && n !== "head" && (O = await Sn(l, r)) !== 0) {
      let N = new Request(t, {
        method: "POST",
        body: r,
        duplex: "half"
...
const xe = (e) => `- ${e}`, On = (e) => a.isFunction(e) || e === null || e === !1, Xe = {
  getAdapter: (e) => {
    e = a.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
...
R.HttpStatusCode = ce;
R.default = R;
var Cn = /* @__PURE__ */ ((e) => (e.Primary = "Primary", e.Success = "Success", e.Warning = "Warning", e.Danger = "Danger", e))(Cn || {});
export {
  R as a,
  Cn as b
};
